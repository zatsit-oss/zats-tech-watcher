 ...
 * exactly 5 columns per row, invalid rows skipped with a warning.
 *
 ...
 *   SHEET_RANGE           optional A1 range, default "A:E" (e.g. "Feuille 1!A:E")
 *
...
const CANONICAL_HEADER = ["Date", "Contributors", "Topics", "Links", "Tags"];
...
async function fetchSheetRows() {
  ...
  const range = process.env.SHEET_RANGE ?? "A:E";
